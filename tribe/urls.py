...
urlpatterns = [
    ...
    path("revent/<int:pk>/location/", views.ReventLocationView.as_view(), name="location-view"),
    path("revent/<int:pk>/country", views.ReventCountryView.as_view(), name="revent-country-update"),
    path("revent/<int:pk>/country/<int:country>/place", views.ReventPlaceView.as_view(), name="revent-place-update"),
    path("revent/<int:pk>/location/add/", views.LocationCreateView.as_view(), name="location-add"),
    path("revent/location/<int:pk>", views.LocationUpdateView.as_view(), name="location-update"),
    path("revent/location/<int:pk>/delete/", views.LocationDeleteView.as_view(), name="location-delete"),
