...
class Conversation(models.Model):
  def __str__(self):
    return "<Conversation: " + self.created_on + ">"
...
class Quote(models.Model):
  def __str__(self):
    return "<Quote " + self.quote_from + " to " + self.quote_to + ": " + self.quote + ">"
...
class Actor(models.Model):
  ...
  conversation = models.ForeignKey(Conversation, on_delete=models.PROTECT, editable=False)
  history = models.ForeignKey(Quote, on_delete=models.PROTECT, editable=False)
