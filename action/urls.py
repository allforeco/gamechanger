...
urlpatterns = [
  ...
  path('admin/location-autocomplete/', views.LocationAutocomplete.as_view()),
  path('admin/country-autocomplete/', views.CountryAutocomplete.as_view()),
  path('admin/organization-autocomplete/', views.OrganizationAutocomplete.as_view()),
