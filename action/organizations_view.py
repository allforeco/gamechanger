...
def organization_view(request, orgid):
  ...
  event_head = Gathering.datalist_template(date=True, location=True, gtype=True, participants=True, recorded_link=True, map_link=True, overview=True, recorded=True, record=True, model=True)
